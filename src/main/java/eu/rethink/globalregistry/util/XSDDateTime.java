...
public class XSDDateTime
{
	...
	// A substring of year, month, day,hours,minute,second is computed. The
	// String "value" is then parsed to date.
	// If the component of parsed date is same as computed substring, then the
	// date is valid as well as values inside date are also valid.
	// For timezone, compute the substring of Timezone and pass it over the
	// function isValidTimeZone.
	// If it returns true, that means the timezone attached to the date is
	// valid.
