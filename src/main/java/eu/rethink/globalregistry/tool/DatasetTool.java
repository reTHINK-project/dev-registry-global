...
//		String command = c.readLine("\n> ");
        ...
        //PrintWriter out = new PrintWriter(new FileWriter("C:/Users/ipart/Desktop/greg/output.txt", true), true);
        while(!command.equals("exit") && !command.equals("x") && !command.equals("quit") && !command.equals("q"))
        {
            if(command.equals("create") || command.equals("c"))
            {
                System.out.print("Choose 'm' for manual dataset creation or 'r' for random dataset creation\n");
                ...
                if(choice.equals("r")){
                    ...
                    try{
                        ...
                        System.out.print("Number of dataset to be captured\n");
                        String num_dataset = in.nextLine();
                        for(int i = 0; i < Integer.valueOf(num_dataset); i++){
                            System.out.print("creating new dataset ...\n");

                            JSONObject json = createRandomDataset();
                            ...
                            //out.write(dataset.getGUID() + "," + jwt + ";\n");
                            fileWriter.append(dataset.getGUID());
                            fileWriter.append(COMMA_DELIMITER);
                            fileWriter.append(jwt);
                            fileWriter.append(NEW_LINE_SEPARATOR);
                        }
                    }
                    catch (Exception e) {
...
//			String inCategory = in.nextLine();
//
//			System.out.print("specify description: \n");
//			String inDescription = in.nextLine();
//
...
//			// TODO implement format check
//
//			legacyIDs.put(new JSONObject().put("id", inID).put("type", inType).put("category", inCategory).put("description", inDescription));
//
//			System.out.print("add another legacyID? (y|n) [n]: \n");
//			inAddLegacyID = in.nextLine();
//			}
//
//			if(!inAddLegacyID.equals("n"))
//			System.out.print("illegal parameter!\n");
//
            //////////////////////////////////////////////////
    ...
    private static JSONObject createRandomDataset()
    {
        Scanner in = new Scanner(System.in);
        ...
        try
        {
            ...
            while(inAddUserID.equals("y"))
            {
                ...
                String inUID = faker.name().firstName();

                //System.out.print("specify uID: \n");
                //String inUID = in.nextLine();

                String inDomain = "outlook.com";
                ...
                if(ch > 0.6 && ch < 0.8){
                    inDomain = "microsoft.com";
                }
                if(ch > 0.8 && ch < 1.0){
                    inDomain = "tu-berlin.de";
                }
            ...
            while(inAddLegacyID.equals("y"))
            {
                ...
                System.out.print("specify type: \n");
                String inType = org.apache.commons.lang.RandomStringUtils.random(8, true, false);

                System.out.print("specify category: \n");
                String inCategory = org.apache.commons.lang.RandomStringUtils.random(8, true, false);

                System.out.print("specify description: \n");
                String inDescription = org.apache.commons.lang.RandomStringUtils.random(8, true, false);

                System.out.print("specify ID: \n");
                String inID = org.apache.commons.lang.RandomStringUtils.random(8, true, false);
