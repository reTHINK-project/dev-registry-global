...
public class PeerCertification {
    ...
    public boolean verifyCertificate(PeerAddress peer) throws CertificateNotFound {
        ...
        GenericUrl url = new GenericUrl("http://" + config.getBlockchainClient() + "/cert/" + peer.getID());
        ...
        try {
            ...
            if(response.getStatusCode() == 200) {
                ...
                throw new CertificateNotFound("Cannot find certificate for peer with ID: " + peer.getID() +
                        " and IP: " + peer.getInetAddress());
            }
